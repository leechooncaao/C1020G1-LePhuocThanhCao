        ...
        <div class="table-wrapper">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <div class="search-box">
                            <form action="employeeServlet" id="searchForm">
            ...
            <table id="tableEmployee" class="table table-striped table-hover table-bordered table-responsive text-nowrap">
                ...
                <tr>
                    ...
                    <th>
                        Name
                        <a href="/employeeServlet?action=sortByName">
                ...
                <tbody>
                <c:forEach var="service" items="${listEmployee}">
                    <tr>
                        <td><c:out value="${service.id}" /></td>
                        <td><c:out value="${service.name}" /></td>
                        <td><c:out value="${service.birthday}" /></td>
                        <td><c:out value="${service.idCard}" /></td>
                        <td><c:out value="${service.salary}" /></td>
                        <td><c:out value="${service.phone}" /></td>
                        <td><c:out value="${service.email}" /></td>
                        <td><c:out value="${service.address}" /></td>
                        <td><c:out value="${service.position}" /></td>
                        <td><c:out value="${service.degree}" /></td>
                        <td><c:out value="${service.division}" /></td>
                        <td><c:out value="${service.userName}" /></td>
                        <td>
                            <a
                                    href="/employeeServlet?action=edit&id=${service.id}"
                                    class="edit"
                                    title="Edit"
                                    data-toggle="tooltip"
                            ...
                            <a
                                    ...
                                    title="Delete"
                                    data-toggle="modal"
                                    onclick="setIdEmployee('${service.id}')"
                            >
                                <i class="material-icons">&#xE872;</i>
                            </a>
                        </td>
...
<form action="/employeeServlet" id="delete-employee">
    <input type="hidden" name="action" value="delete" />
    <input type="hidden" id="id-employee" name="id" />
</form>
...
<script>
    ...
    function setIdEmployee(idEmployee) {
        document.getElementById("id-employee").value = idEmployee;
    }
